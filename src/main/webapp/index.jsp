...
<div class="layui-layout layui-layout-admin"> <!-- 添加skin-1类可手动修改主题为纯白，添加skin-2类可手动修改主题为蓝白 -->
    ...
    <div class="layui-header my-header">
        <a href="index.html">
            ...
            <div class="my-header-logo">BM</div>
        </a>
        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="side-main">
                <li class="layui-nav-item  layui-nav-itemed">
                    <a href="javascript:;"><i class="layui-icon">&#xe620;</i>基础</a>
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" href-url="quota/index"><i class="layui-icon">&#xe621;</i>水配额</a></dd>
                        <%--<dd><a href="javascript:;" href-url=""><i class="layui-icon">&#xe621;</i>表单</a></dd>--%>
                        <%--<dd><a href="javascript:;" href-url=""><i class="layui-icon">&#xe621;</i>表格</a></dd>--%>
                        <%--<dd><a href="javascript:;" href-url=""><i class="layui-icon">&#xe621;</i>选项卡</a></dd>--%>
                        <%--<dd><a href="javascript:;" href-url=""><i class="layui-icon">&#xe621;</i>进度条</a></dd>--%>
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd><a href="javascript:;" href-url="tree-table.jsp"><i class="layui-icon">&#xe621;</i>户主信息</a></dd>
        ...
        <div class="layui-tab layui-tab-card my-tab" lay-filter="card" lay-allowClose="true">
            ...
            <div class="layui-tab-content">
                <div class="layui-tab-item layui-show">
                    <iframe id="iframe" src="tree-table.jsp" frameborder="0">
