...
">
        ...
        <div style="margin-left: 139px">
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <textarea style="width: 270px;height: 60px;">
                            说明在平台想做的工作内容，以便管理员给你注册不同平台的功能授权。 (限定500字符以内)
                        </textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    <label class="layui-form-label" >系统平台用户协议*</label>
                    <div class="layui-input-block" style="margin-top: 18px">
                        <a href="">《系统平台用户协议》点击阅读</a>
                    </div>
                </div>
                <%--单选项、同意&不同意--%>
                <div class="layui-input-block">
                    <input type="radio" name="sex" value="同意" title="同意" checked>
                    <div class="layui-unselect layui-form-radio layui-form-radioed">
                        <i class="layui-anim layui-icon layui-anim-scaleSpring"></i>
                        <span>同意</span>
                    </div>
                    <input type="radio" name="sex" value="不同意" title="不同意" >
    ...
    <%-------------------------------------BOTTON--------------------------------------------------------------%>
    <div class="layui-form-item" style="margin-left: 10px;margin-top: 25px">
        <%--上一页按钮--%>
        <div class="layui-input-inline">
        ...
        <%--提交注册--%>
        <div class="layui-input-inline">
            <a href="/registerEnd" class="layui-btn layui-btn-primary" style="color: rgba(16,31,255,0.9)">提交注册</a>
        </div>
        <%--退出按钮--%>
        <div class="layui-input-inline">
